//
//  PrintInstructionsProtocol.swift
 ...
 *  打印指令接口(58mm打印机编程手册)
 */
public protocol PrintInstructionProtocol {
    ...
    /**
     ...
     - parameter size:   二维码大小 1 <= size <= 16
     - parameter ecc:    纠错等级
...
// MARK: - 打印指令扩展
public extension PrintInstructionProtocol {
